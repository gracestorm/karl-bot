...
# Укажи здесь точный адрес твоего приложения на Render (без слэша на конце)
# Например: "https://karl-bot-5asy.onrender.com"
RENDER_EXTERNAL_URL = os.getenv("RENDER_EXTERNAL_URL", "https://karl-bot-5asy.onrender.com")
